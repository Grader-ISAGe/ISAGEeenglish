...
/**
 * Represents an ISAGEeenglish question.
 *
 * @copyright  
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
...
class qtype_ISAGEeenglish_question extends question_graded_automatically {
...
/********************************************************************************************/
     ...
     */
        ...
        return get_string('pleaseenterananswer', 'qtype_ISAGEeenglish');
    }
...
/**
    ...
    public function grade_response(array $response) {
     ...
     // Call to the external Grader 
        ...
        curl_setopt($curlvar,CURLOPT_URL,'http://ISAGEeenglish.pythonanywhere.com/?donnee='.self::checkInput($donnee).'&data='.self::checkInput($data).'&quest='.self::checkInput($quest)); //Set the Url
