...
require_once($CFG->dirroot . '/question/type/ISAGEeenglish/question.php');


/**
 * The ISAGEeenglish question type.
 *
 * @copyright   

 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ISAGEeenglish extends question_type {
 ...
 /**
     ...
     */
        ...
        // Save question options in question_ISAGEeenglish table.
       
        if ($options = $DB->get_record('qtype_ISAGEeenglish_options', array('questionid' => $question->id))) {
            // No need to do anything, since the answer IDs won't have changed
            // But we'll do it anyway, just for robustness.
 
            $DB->update_record('qtype_ISAGEeenglish_options', $options);
        } else {
            $options = new stdClass();
            $options->questionid  = $question->id;
            
            $DB->insert_record('qtype_ISAGEeenglish_options', $options);
        }
...
/**
 ...
 public function delete_question($questionid, $contextid) {
        global $DB;
        $DB->delete_records('qtype_ISAGEeenglish_options', array('questionid' => $questionid));
    ...
    public function get_question_options($question) {
     ...
     if (!isset($question->options)) {
        ...
        $question->options = $DB->get_record('qtype_ISAGEeenglish_options',
